        ...
        <thead className="border-b border-theme bg-surface-2">
          {columnGroupMode === "nutrient" ? (
            <>
              ...
              <tr>
                {fixedThs}
                {visibility.show100g ? <th className={`${headerClass} border-x border-violet-400/20 bg-violet-400/5 text-violet-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.protein} options={filterOptions.proteins} onChange={(v) => onFilter("protein", v)} formatFn={(n) => `${n}g`} numeric /><span>/100g</span></div></th> : null}
                ...
                {visibility.show100g ? <th className={`${headerClass} border-x border-amber-500/20 bg-amber-500/5 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPer100g} options={filterOptions.caloriesPer100gs} onChange={(v) => onFilter("caloriesPer100g", v)} formatFn={(n) => `${n}`} numeric /><span>/100g</span></div></th> : null}
                {visibility.showServing ? <th className={`${headerClass} border-x border-amber-500/20 bg-amber-500/5 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPerServing} options={filterOptions.caloriesPerServings} onChange={(v) => onFilter("caloriesPerServing", v)} formatFn={(n) => `${n}`} numeric /><span>/Serving</span></div></th> : null}
                {visibility.show1gProtein ? <th className={`${headerClass} border-x border-amber-500/20 bg-amber-500/5 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPerGramProtein} options={filterOptions.caloriesPerGramProteins} onChange={(v) => onFilter("caloriesPerGramProtein", v)} formatFn={(n) => n.toFixed(2)} numeric /><span>/1g Protein</span></div></th> : null}
            ...
            <>
              ...
              <tr>
                ...
                {visibility.showServing ? <th className={`${headerClass} bg-surface-2 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPerServing} options={filterOptions.caloriesPerServings} onChange={(v) => onFilter("caloriesPerServing", v)} formatFn={(n) => `${n}`} numeric /><span>kcal</span></div></th> : null}
                ...
                {visibility.show100g ? <th className={`${headerClass} border-l border-theme bg-surface-2 text-violet-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.protein} options={filterOptions.proteins} onChange={(v) => onFilter("protein", v)} formatFn={(n) => `${n}g`} numeric /><span>Protein</span></div></th> : null}
                {visibility.show100g ? <th className={`${headerClass} bg-surface-2 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPer100g} options={filterOptions.caloriesPer100gs} onChange={(v) => onFilter("caloriesPer100g", v)} formatFn={(n) => `${n}`} numeric /><span>kcal</span></div></th> : null}
                ...
                {visibility.show1gProtein ? <th className={`${headerClass} border-l border-theme bg-surface-2 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPerGramProtein} options={filterOptions.caloriesPerGramProteins} onChange={(v) => onFilter("caloriesPerGramProtein", v)} formatFn={(n) => n.toFixed(2)} numeric /><span>kcal</span></div></th> : null}
