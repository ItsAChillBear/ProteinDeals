        ...
        <thead className="border-b border-theme bg-surface-2">
          {columnGroupMode === "nutrient" ? (
            <>
              ...
              <tr>
                {fixedThs}
                {visibility.show100g ? <th className={`${headerClass} border-x border-violet-400/20 bg-violet-400/5 text-violet-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.protein} options={filterOptions.proteins} onChange={(v) => onFilter("protein", v)} formatFn={(n) => `${n}g`} numeric />{sortableHeader("/100g", "proteinPer100g")}</div></th> : null}
                {visibility.showServing ? <th className={`${headerClass} border-x border-violet-400/20 bg-violet-400/5 text-violet-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.proteinPerServing} options={filterOptions.proteinPerServings} onChange={(v) => onFilter("proteinPerServing", v)} formatFn={(n) => `${n.toFixed(1)}g`} numeric />{sortableHeader("/Serving", "proteinPerServing")}</div></th> : null}
                {visibility.show100g ? <th className={`${headerClass} border-x border-amber-500/20 bg-amber-500/5 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPer100g} options={filterOptions.caloriesPer100gs} onChange={(v) => onFilter("caloriesPer100g", v)} formatFn={(n) => `${n}`} numeric />{sortableHeader("/100g", "caloriesPer100g")}</div></th> : null}
                {visibility.showServing ? <th className={`${headerClass} border-x border-amber-500/20 bg-amber-500/5 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPerServing} options={filterOptions.caloriesPerServings} onChange={(v) => onFilter("caloriesPerServing", v)} formatFn={(n) => `${n}`} numeric />{sortableHeader("/Serving", "caloriesPerServing")}</div></th> : null}
                {visibility.show1gProtein ? <th className={`${headerClass} border-x border-amber-500/20 bg-amber-500/5 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPerGramProtein} options={filterOptions.caloriesPerGramProteins} onChange={(v) => onFilter("caloriesPerGramProtein", v)} formatFn={(n) => n.toFixed(2)} numeric />{sortableHeader("/1g Protein", "caloriesPerGramProtein")}</div></th> : null}
                {visibility.showTotal ? <th className={`${headerClass} border-x border-green-500/20 bg-green-500/5 text-green-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.price} options={filterOptions.prices} onChange={(v) => onFilter("price", v)} formatFn={(n) => `£${n.toFixed(2)}`} numeric />{sortableHeader("Total", "price")}</div></th> : null}
                {visibility.show100g ? <th className={`${headerClass} border-x border-green-500/20 bg-green-500/5 text-green-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.pricePer100g} options={filterOptions.pricePer100gs} onChange={(v) => onFilter("pricePer100g", v)} formatFn={(n) => `£${n.toFixed(2)}`} numeric />{sortableHeader("/100g", "pricePer100g")}</div></th> : null}
                {visibility.showServing ? <th className={`${headerClass} border-x border-green-500/20 bg-green-500/5 text-green-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.pricePerServing} options={filterOptions.pricePerServings} onChange={(v) => onFilter("pricePerServing", v)} formatFn={(n) => `£${n.toFixed(3)}`} numeric />{sortableHeader("/Serving", "pricePerServing")}</div></th> : null}
                {visibility.show1gProtein ? <th className={`${headerClass} border-x border-green-500/20 bg-green-500/5 text-green-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.pricePerGramProtein} options={filterOptions.pricePerGramProteins} onChange={(v) => onFilter("pricePerGramProtein", v)} formatFn={(n) => `£${n.toFixed(3)}`} numeric />{sortableHeader("/1g Protein", "pricePerGramProtein")}</div></th> : null}
              </tr>
            </>
          ) : (
            <>
              ...
              <tr>
                ...
                {visibility.showServing ? <th className={`${headerClass} bg-surface-2 text-violet-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.proteinPerServing} options={filterOptions.proteinPerServings} onChange={(v) => onFilter("proteinPerServing", v)} formatFn={(n) => `${n.toFixed(1)}g`} numeric />{sortableHeader("Protein", "proteinPerServing")}</div></th> : null}
                {visibility.showServing ? <th className={`${headerClass} bg-surface-2 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPerServing} options={filterOptions.caloriesPerServings} onChange={(v) => onFilter("caloriesPerServing", v)} formatFn={(n) => `${n}`} numeric />{sortableHeader("kcal", "caloriesPerServing")}</div></th> : null}
                {visibility.showServing ? <th className={`${headerClass} border-r border-theme bg-surface-2 text-green-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.pricePerServing} options={filterOptions.pricePerServings} onChange={(v) => onFilter("pricePerServing", v)} formatFn={(n) => `£${n.toFixed(3)}`} numeric />{sortableHeader("Price", "pricePerServing")}</div></th> : null}
                {visibility.show100g ? <th className={`${headerClass} border-l border-theme bg-surface-2 text-violet-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.protein} options={filterOptions.proteins} onChange={(v) => onFilter("protein", v)} formatFn={(n) => `${n}g`} numeric />{sortableHeader("Protein", "proteinPer100g")}</div></th> : null}
                {visibility.show100g ? <th className={`${headerClass} bg-surface-2 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPer100g} options={filterOptions.caloriesPer100gs} onChange={(v) => onFilter("caloriesPer100g", v)} formatFn={(n) => `${n}`} numeric />{sortableHeader("kcal", "caloriesPer100g")}</div></th> : null}
                {visibility.show100g ? <th className={`${headerClass} border-r border-theme bg-surface-2 text-green-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.pricePer100g} options={filterOptions.pricePer100gs} onChange={(v) => onFilter("pricePer100g", v)} formatFn={(n) => `£${n.toFixed(2)}`} numeric />{sortableHeader("Price", "pricePer100g")}</div></th> : null}
                {visibility.show1gProtein ? <th className={`${headerClass} border-l border-theme bg-surface-2 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPerGramProtein} options={filterOptions.caloriesPerGramProteins} onChange={(v) => onFilter("caloriesPerGramProtein", v)} formatFn={(n) => n.toFixed(2)} numeric />{sortableHeader("kcal", "caloriesPerGramProtein")}</div></th> : null}
                {visibility.show1gProtein ? <th className={`${headerClass} border-r border-theme bg-surface-2 text-green-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.pricePerGramProtein} options={filterOptions.pricePerGramProteins} onChange={(v) => onFilter("pricePerGramProtein", v)} formatFn={(n) => `£${n.toFixed(3)}`} numeric />{sortableHeader("Price", "pricePerGramProtein")}</div></th> : null}
              </tr>
            </>
          )}
        </thead>
