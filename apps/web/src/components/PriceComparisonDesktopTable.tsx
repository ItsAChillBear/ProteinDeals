          ...
          {columnGroupMode === "nutrient" ? (
            ...
            <>
              ...
              <tr>
                ...
                {visibility.showServing ? <th className={`${headerClass} border-x border-theme bg-surface-2 text-green-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.pricePerServing} options={filterOptions.pricePerServings} onChange={(v) => onFilter("pricePerServing", v)} formatFn={(n) => `£${n.toFixed(3)}`} numeric />{sortableHeader("Price", "pricePerServing")}</div></th> : null}
                ...
                {visibility.show100g ? <th className={`${headerClass} border-x border-theme bg-surface-2 text-green-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.pricePer100g} options={filterOptions.pricePer100gs} onChange={(v) => onFilter("pricePer100g", v)} formatFn={(n) => `£${n.toFixed(2)}`} numeric />{sortableHeader("Price", "pricePer100g")}</div></th> : null}
                ...
                {visibility.show1gProtein ? <th className={`${headerClass} border-x border-theme bg-surface-2 text-green-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.pricePerGramProtein} options={filterOptions.pricePerGramProteins} onChange={(v) => onFilter("pricePerGramProtein", v)} formatFn={(n) => `£${n.toFixed(3)}`} numeric />{sortableHeader("Price", "pricePerGramProtein")}</div></th> : null}
              </tr>
            </>
          )}
        </thead>
