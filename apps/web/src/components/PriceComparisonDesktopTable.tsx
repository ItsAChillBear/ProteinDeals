...
export default function PriceComparisonDesktopTable({
  ...
  // measure mode spans
  const servingColSpan = visibility.showServing ? 4 : 0; // servings, protein, kcal, price
    ...
    <th className="px-2 pt-2 pb-0 text-center text-[10px] font-bold uppercase tracking-widest text-green-500/80 border-x border-t border-green-500/20 bg-green-500/5" rowSpan={2}>
      <div className="flex flex-col items-center gap-1 pb-1">
        ...
        <div className="flex gap-1">
          <button type="button" onClick={() => onSort("dailyCost")} className={`inline-flex items-center gap-0.5 rounded px-1.5 py-0.5 text-[9px] font-semibold transition ${sortKey === "dailyCost" ? "bg-green-500/30 text-green-300" : "bg-gray-700/60 text-gray-400 hover:text-gray-200"}`}>
            £<SortIcon col="dailyCost" sortKey={sortKey} sortDir={sortDir} />
          </button>
          {planner.calorieEnabled ? (
            <button type="button" onClick={() => onSort("dailyCalories")} className={`inline-flex items-center gap-0.5 rounded px-1.5 py-0.5 text-[9px] font-semibold transition ${sortKey === "dailyCalories" ? "bg-amber-500/30 text-amber-300" : "bg-gray-700/60 text-gray-400 hover:text-gray-200"}`}>
          ...
          {columnGroupMode === "nutrient" ? (
            <>
              <tr>
                {plannerTh}
                <th colSpan={4} />
                {proteinColSpan > 0 ? <th colSpan={proteinColSpan} className="px-2 pt-2 pb-0 text-center text-[10px] font-bold uppercase tracking-widest text-violet-400/80 border-x border-t border-violet-400/20 bg-violet-400/5">Protein</th> : null}
                ...
                {priceColSpan > 0 ? <th colSpan={priceColSpan} className="px-2 pt-2 pb-0 text-center text-[10px] font-bold uppercase tracking-widest text-sky-400/80 border-x border-t border-sky-400/20 bg-sky-400/5">Price</th> : null}
              </tr>
              <tr>
                {fixedThs}
            ...
            <>
              <tr>
                ...
                {visibility.showServing ? <th colSpan={servingColSpan} className="px-2 pt-2 pb-0 text-center text-[10px] font-bold uppercase tracking-widest text-gray-400 bg-gray-800/60 border-x border-t border-gray-700/50">Per Serving</th> : null}
                {visibility.show100g ? <th colSpan={per100gColSpan} className="px-2 pt-2 pb-0 text-center text-[10px] font-bold uppercase tracking-widest text-gray-400 bg-gray-800/60 border-x border-t border-gray-700/50">Per 100g</th> : null}
                {visibility.show1gProtein ? <th colSpan={per1gProteinColSpan} className="px-2 pt-2 pb-0 text-center text-[10px] font-bold uppercase tracking-widest text-gray-400 bg-gray-800/60 border-x border-t border-gray-700/50">Per 1g Protein</th> : null}
              </tr>
              <tr>
                <th className={`${headerClass} w-28`}>{sortableHeader("Product", "name")}</th>
                ...
                {visibility.showTotal ? <th className={`${headerClass} border-x border-sky-400/20 bg-sky-400/5`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.price} options={filterOptions.prices} onChange={(v) => onFilter("price", v)} formatFn={(n) => `£${n.toFixed(2)}`} numeric />{sortableHeader("Total", "price")}</div></th> : null}
                {visibility.showServing ? <th className={`${headerClass} border-x border-gray-700/50 bg-gray-800/60 text-gray-500`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.servings} options={filterOptions.servings} onChange={(v) => onFilter("servings", v)} formatFn={(n) => `${n}`} numeric /><span>Servings</span></div></th> : null}
                {visibility.showServing ? <th className={`${headerClass} border-x border-gray-700/50 bg-gray-800/60 text-violet-400/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.proteinPerServing} options={filterOptions.proteinPerServings} onChange={(v) => onFilter("proteinPerServing", v)} formatFn={(n) => `${n.toFixed(1)}g`} numeric /><span>Protein</span></div></th> : null}
                {visibility.showServing ? <th className={`${headerClass} border-x border-gray-700/50 bg-gray-800/60 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPerServing} options={filterOptions.caloriesPerServings} onChange={(v) => onFilter("caloriesPerServing", v)} formatFn={(n) => `${n}`} numeric /><span>kcal</span></div></th> : null}
                {visibility.showServing ? <th className={`${headerClass} border-x border-gray-700/50 bg-gray-800/60 text-sky-400/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.pricePerServing} options={filterOptions.pricePerServings} onChange={(v) => onFilter("pricePerServing", v)} formatFn={(n) => `£${n.toFixed(3)}`} numeric />{sortableHeader("Price", "pricePerServing")}</div></th> : null}
                {visibility.show100g ? <th className={`${headerClass} border-x border-gray-700/50 bg-gray-800/60 text-violet-400/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.protein} options={filterOptions.proteins} onChange={(v) => onFilter("protein", v)} formatFn={(n) => `${n}g`} numeric /><span>Protein</span></div></th> : null}
                {visibility.show100g ? <th className={`${headerClass} border-x border-gray-700/50 bg-gray-800/60 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPer100g} options={filterOptions.caloriesPer100gs} onChange={(v) => onFilter("caloriesPer100g", v)} formatFn={(n) => `${n}`} numeric /><span>kcal</span></div></th> : null}
                {visibility.show100g ? <th className={`${headerClass} border-x border-gray-700/50 bg-gray-800/60 text-sky-400/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.pricePer100g} options={filterOptions.pricePer100gs} onChange={(v) => onFilter("pricePer100g", v)} formatFn={(n) => `£${n.toFixed(2)}`} numeric />{sortableHeader("Price", "pricePer100g")}</div></th> : null}
                {visibility.show1gProtein ? <th className={`${headerClass} border-x border-gray-700/50 bg-gray-800/60 text-amber-500/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.caloriesPerGramProtein} options={filterOptions.caloriesPerGramProteins} onChange={(v) => onFilter("caloriesPerGramProtein", v)} formatFn={(n) => n.toFixed(2)} numeric /><span>kcal</span></div></th> : null}
                {visibility.show1gProtein ? <th className={`${headerClass} border-x border-gray-700/50 bg-gray-800/60 text-sky-400/70`}><div className="flex flex-col items-center gap-1.5"><PriceComparisonFilterDropdown value={filters.pricePerGramProtein} options={filterOptions.pricePerGramProteins} onChange={(v) => onFilter("pricePerGramProtein", v)} formatFn={(n) => `£${n.toFixed(3)}`} numeric />{sortableHeader("Price", "pricePerGramProtein")}</div></th> : null}
              </tr>
            </>
          )}
        </thead>
