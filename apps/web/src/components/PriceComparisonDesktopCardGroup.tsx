...
export default function PriceComparisonDesktopCardGroup({
  ...
  return (
    <tr className={clsx("transition-colors", isBestValue ? "bg-green-500/5 hover:bg-green-500/10" : "hover-bg")}>
      <td colSpan={totalColumns} className="px-4 py-3">
        ...
        {isExpanded ? (
          <div className={clsx("mt-3 rounded-xl px-4 py-3", isBestValue ? "bg-green-500/5" : "bg-surface")}>
    ...
    <div className="flex border-b border-theme bg-surface-2">
      <div className="w-44 flex-shrink-0 flex flex-col justify-end">
        ...
        <div className="flex mb-1 pl-5">
          ...
          {visibility.showTotal ? <span className="w-20 flex-shrink-0 text-center text-[10px] font-bold uppercase tracking-widest text-sky-500/80">Total</span> : null}
        </div>
        <div className="flex">
